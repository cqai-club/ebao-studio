...
describe('AccountServiceClient', () => {
  ...
  it('reads and normalizes the Account Service model catalog', async () => {
      ...
      data: [
        {
          ...
          architecture: {
            ...
            input_modalities: ['text', 'image', 'sensor', 'image'],
            output_modalities: ['text'],
          },
          supported_parameters: ['tools', 'future_parameter', 'tools'],
    ...
    await expect(client.getModels('access-secret')).resolves.toEqual([
      {
        id: 'vision-model',
        canonicalSlug: 'openai/vision-model-20260915',
        name: 'Vision Model',
        ownedBy: 'relay',
        vendor: 'CQAI',
        description: 'A multimodal model',
        ...
        supportedParameters: ['tools', 'future_parameter'],
