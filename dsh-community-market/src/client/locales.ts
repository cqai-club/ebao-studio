export const zh = {
  ...
  manualInstallBody: '以下命令由 易宝工坊 根据插件信息生成，可能与仓库中的说明不同。请先检查源码，再复制到 DSH 终端执行。',
  installCommand: '安装命令',
  ...
  restartError: '无法请求重启 易宝工坊，请稍后手动重启。',
  ...
  desktopRequiredTitle: '需要 易宝工坊',
  desktopUnavailable: '安装和卸载只在 易宝工坊 中可用；你仍然可以浏览插件目录。',
  ...
  installFailedBody: '易宝工坊 未能完成自动安装。你可以查看详细输出，或前往 DSH 终端手动安装。',
  installFailureTerminalHint: '自动安装失败后不会再次使用同一个确认请求。请检查下面的输出；如需继续，可以打开 DSH 终端并手动执行安装命令。',
  failureOutput: '详细输出',
  noFailureOutput: '没有收到 package manager 的额外输出。请查看 易宝工坊 日志了解更多信息。',
  plugin: '插件',
  package: 'npm 包',
  exactVersion: '精确版本',
  profile: '当前配置',
  ...
  confirmInstallBody: '请确认 易宝工坊 验证的 npm 包、版本和目标配置。',
  ...
  restartAfterOperation: '操作完成后需要重启 易宝工坊，改动才会生效。',
  disabledRestartRequired: '此插件保留了未加载状态；插件市场仍只提供卸载。',
  installComplete: '插件安装完成',
  uninstallComplete: '插件卸载完成',
  restartRequiredTitle: '需要重启 易宝工坊',
  restartRequiredBody: '请重启 易宝工坊，让当前配置加载最新的插件状态。',
  restartLater: '稍后重启',
  restartNow: '立即重启',
  restarting: '正在重启...',
  done: '完成',
...
export const en: Record<MarketLocaleKey, string> = {
  tab: 'CQAI Plugin Market',
  title: 'CQAI Plugin Market',
  subtitle: 'Discover, install, and manage CQAI plugins',
  close: 'Close',
  ...
  manualInstallBody: '易宝工坊 generated this command from the plugin information, so it may differ from the repository instructions. Review the source first, then copy it into DSH Terminal.',
  ...
  restartError: '易宝工坊 could not be restarted. Restart it manually when convenient.',
  ...
  desktopRequiredTitle: '易宝工坊 is required',
  desktopUnavailable: 'Install and uninstall are available only in 易宝工坊. You can still browse the catalog.',
  ...
  installFailedBody: '易宝工坊 could not complete the automatic installation. Review the detailed output or continue manually in DSH Terminal.',
  ...
  noFailureOutput: 'The package manager returned no additional output. Check the 易宝工坊 logs for more information.',
  plugin: 'Plugin',
  package: 'npm package',
  ...
  confirmInstallBody: 'Review the npm package, version, and target profile verified by 易宝工坊.',
  ...
  restartAfterOperation: 'Restart 易宝工坊 after this operation for the change to take effect.',
  ...
  restartRequiredTitle: 'Restart 易宝工坊',
  restartRequiredBody: 'Restart 易宝工坊 so the current profile loads its updated plugin state.',
