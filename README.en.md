...
<p align="center">
  <img src="assets/desktop-chat-en.png" alt="易宝工坊 chat interface in English" width="100%">
</p>
...
易宝工坊 integrates the local Web UI, Host service, and plugin system from [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) into a native desktop application. It runs a pinned upstream version unchanged, while 易宝工坊 provides the window, tray, terminal, updates, and work profiles through the plugin mechanism provided by DeepSeek Harness.
...
| Understand why the project exists | [Why 易宝工坊](docs/why-desktop.en.md) |
...
<table>
  ...
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <p>The DSH plugin ecosystem is built by the community. Upstream plugins, 易宝工坊 plugins, and other community plugins follow shared conventions and can work together through the same composition mechanism. Join us — read the <a href="docs/plugin-ecosystem.en.md">DSH plugin ecosystem manifesto</a>.</p>
    </td>
  </tr>
</table>
...
The upstream project provides the core agent capabilities, plugin system, and Web UI. 易宝工坊 primarily provides:
...
Special thanks to the [original DeepSeek Harness repository](https://github.com/deepseek-ai/deepseek-harness) and the DeepSeek AI team. 易宝工坊 is built from a pinned upstream checkout, and its core agents, models, tools, sessions, Web UI, and plugin ecosystem come from that project.

We also thank [Cordis](https://github.com/cordiverse/cordis) for the plugin foundation that makes this composition possible. 易宝工坊 would not exist without these open-source projects.
...
<table>
  ...
  <tbody>
    <tr>
      <td align="center"><img src="assets/community-wechat-group.png" alt="易宝工坊 WeCom QR code" title="Scan to add us on WeCom" width="180" height="180"></td>
      <td align="center"><img src="assets/community-qq-group.jpg" alt="易宝工坊 QQ group QR code" width="180" height="180"></td>
    </tr>
  </tbody>
</table>

Discord: [Join the 易宝工坊 community](https://discord.gg/TJeGqKRNM)
...
> 易宝工坊 is an independent community project and is not affiliated with, sponsored by, authorized by, or endorsed by DeepSeek.
