/** Export native Icon Composer artwork for Next; eBao Stable/Beta package branded PNG/ICO assets. */
...
async function main() {
  ...
  const requested = args.includes('--channel') ? args[args.indexOf('--channel') + 1] : 'next'
